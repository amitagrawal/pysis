...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Profile.google_account_created'
        db.add_column('accounts_profile', 'google_account_created', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Profile.google_account_created'
        db.delete_column('accounts_profile', 'google_account_created')
