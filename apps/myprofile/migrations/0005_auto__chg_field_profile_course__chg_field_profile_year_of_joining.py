...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Profile.course'
        db.alter_column('myprofile_profile', 'course_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['myprofile.Course']))

        # Changing field 'Profile.year_of_joining'
        db.alter_column('myprofile_profile', 'year_of_joining', self.gf('django.db.models.fields.DecimalField')(max_digits=4, decimal_places=0))


    def backwards(self, orm):
        
        # Changing field 'Profile.course'
        db.alter_column('myprofile_profile', 'course_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['myprofile.Course'], null=True, blank=True))

        # Changing field 'Profile.year_of_joining'
        db.alter_column('myprofile_profile', 'year_of_joining', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=4, decimal_places=0, blank=True))
    ...
    models = {
        ...
        'myprofile.profile': {
            ...
            'course': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['myprofile.Course']"}),
            ...
            'year_of_joining': ('django.db.models.fields.DecimalField', [], {'max_digits': '4', 'decimal_places': '0'})
        }
    }
