...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Course'
        db.create_table('myprofile_course', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('course_name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=30)),
            ('course_level', self.gf('django.db.models.fields.CharField')(default='UG', max_length=4)),
        ))
        db.send_create_signal('myprofile', ['Course'])

        # Adding model 'Profile'
        db.create_table('myprofile_profile', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], unique=True)),
            ('course', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['myprofile.Course'], null=True, blank=True)),
            ...
            ('personal_contact_number', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('personal_contact_number2', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('emergency_contact_number', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
        ...
        db.send_create_signal('myprofile', ['Profile'])


    def backwards(self, orm):
        
        # Deleting model 'Course'
        db.delete_table('myprofile_course')

        # Deleting model 'Profile'
        db.delete_table('myprofile_profile')
    ...
    models = {
        ...
        'myprofile.profile': {
            ...
            'emergency_contact_number': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'personal_contact_number': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'personal_contact_number2': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
