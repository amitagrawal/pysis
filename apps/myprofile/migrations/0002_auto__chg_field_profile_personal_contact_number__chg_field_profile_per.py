...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Profile.personal_contact_number'
        db.alter_column('myprofile_profile', 'personal_contact_number', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True))

        # Changing field 'Profile.personal_contact_number2'
        db.alter_column('myprofile_profile', 'personal_contact_number2', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True))

        # Changing field 'Profile.emergency_contact_number'
        db.alter_column('myprofile_profile', 'emergency_contact_number', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True))


    def backwards(self, orm):
        
        # Changing field 'Profile.personal_contact_number'
        db.alter_column('myprofile_profile', 'personal_contact_number', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True))

        # Changing field 'Profile.personal_contact_number2'
        db.alter_column('myprofile_profile', 'personal_contact_number2', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True))

        # Changing field 'Profile.emergency_contact_number'
        db.alter_column('myprofile_profile', 'emergency_contact_number', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True))
    ...
    models = {
        ...
        'myprofile.course': {
            ...
            'course_level': ('django.db.models.fields.CharField', [], {'default': "'UG'", 'max_length': '4'}),
